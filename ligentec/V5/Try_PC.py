...
pathC1_Ground = gdspy.Path(width = 5 , initial_point = (pathC1_B_Upper.x + 100 , (pathC1_B_Upper.y + pathC1_T_Lowwer.y)/2))
pathC1_Ground.segment(length = 5 , direction = "+x" , **ld_LNARFP)
...
pathC2_Ground = gdspy.Path(width = 5 , initial_point = (pathC2_B_Upper.x - 100 , (pathC2_B_Upper.y + pathC2_T_Lowwer.y)/2))
pathC2_Ground.segment(length = 5 , direction = "-x" , **ld_LNARFP)
...
pathC3_Ground.segment(length = 5 , direction = "+x" , **ld_LNARFP)
