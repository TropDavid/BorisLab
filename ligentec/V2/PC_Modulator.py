...
def Mod (x = 0 , y = 0 , L = 0 ,B = 0):
    ...
    cell.add(gdspy.CellReference(C_S, (Left_Electrode_x - Overlap_Length*4 - B*300 , y)))
    cell.add(gdspy.CellReference(GSGM, (pathTop.x-Overlap_Length ,y)))
    cell.add(gdspy.CellReference(C_E, (Right_Electrode_x + Overlap_Length*4 + B*300 ,y)))
