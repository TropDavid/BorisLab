...
# Load Main Mask
lib.read_gds('cielo_ELOP_Rev1.0v3.0.GDS')
...
# Logos
    if n> 45:
        ...
        dicing_cell.add(gdspy.CellReference(cieloLogo,  (cells[n,0]+400,
            cells[n,1]+3000+15000),magnification=4,rotation =90))
...
insert_tiles([2],"wgEL=2",cielo_wg,wg_length = 20000 ,x=0,y=0, el_length = 10000 , el_gap = 17 , el_width = 400  , Width_WG = 5)
insert_tiles([3],"wgEL=3",cielo_wg,wg_length = 20000 ,x=0,y=0, el_length = 10000 , el_gap = 17 , el_width = 400  , Width_WG = 5.5)
insert_tiles([4],"wgEL=4",cielo_wg,wg_length = 20000 ,x=0,y=0, el_length = 10000 , el_gap = 17 , el_width = 20  , Width_WG = 4)
insert_tiles([5],"wgEL=5",cielo_wg,wg_length = 20000 ,x=0,y=0, el_length = 10000 , el_gap = 17 , el_width = 20  , Width_WG = 4.5)
insert_tiles([6],"wgEL=6",cielo_wg,wg_length = 20000 ,x=0,y=0, el_length = 10000 , el_gap = 17 , el_width = 20  , Width_WG = 5)
insert_tiles([7],"wgEL=7",cielo_wg,wg_length = 20000 ,x=0,y=0, el_length = 10000 , el_gap = 17 , el_width = 20  , Width_WG = 5.5)
insert_tiles([8],"wgEL=8",cielo_wg,wg_length = 20000 ,x=0,y=0, el_length = 15000 , el_gap = 15 , el_width = 20  , Width_WG = 4)
insert_tiles([9],"wgEL=9",cielo_wg,wg_length = 20000 ,x=0,y=0, el_length = 15000 , el_gap = 15 , el_width = 20  , Width_WG = 4.5)
insert_tiles([10],"wgEL=10",cielo_wg,wg_length = 20000 ,x=0,y=0, el_length = 15000 , el_gap = 15 , el_width = 20  , Width_WG = 5)
insert_tiles([11],"wgEL=11",cielo_wg,wg_length = 20000 ,x=0,y=0, el_length = 15000 , el_gap = 15 , el_width = 20  , Width_WG = 5.5)
insert_tiles([12],"wgEL=12",cielo_wg,wg_length = 20000 ,x=0,y=0, el_length = 15000 , el_gap = 20 , el_width = 200  , Width_WG = 4)
insert_tiles([13],"wgEL=13",cielo_wg,wg_length = 20000 ,x=0,y=0, el_length = 15000 , el_gap = 20 , el_width = 200  , Width_WG = 4.5)
insert_tiles([14],"wgEL=14",cielo_wg,wg_length = 20000 ,x=0,y=0, el_length = 15000 , el_gap = 17 , el_width = 200  , Width_WG = 5)
insert_tiles([15],"wgEL=15",cielo_wg,wg_length = 20000 ,x=0,y=0, el_length = 15000 , el_gap = 17 , el_width = 200  , Width_WG = 5.5)
...
insert_tiles([18],"Spliter_Close_18",cielo_close_sbend_old , Metal_width = 400 , diss_to_metal = 17  ,Width_WG=5)
insert_tiles([19],"Spliter_Close_19",cielo_close_sbend_old , Metal_width = 400 , diss_to_metal = 17  ,Width_WG=5.5)
insert_tiles([20],"Spliter_Close_20",cielo_close_sbend, Metal_width = 20 , diss_to_metal = 17  ,Width_WG=4)
insert_tiles([21],"Spliter_Close_21",cielo_close_sbend, Metal_width = 20 , diss_to_metal = 17  ,Width_WG=4.5)
insert_tiles([22],"Spliter_Close_22",cielo_close_sbend, Metal_width = 20 , diss_to_metal = 17  ,Width_WG=5)
insert_tiles([23],"Spliter_Close_23",cielo_close_sbend, Metal_width = 20 , diss_to_metal = 17  ,Width_WG=5.5)
insert_tiles([24],"Spliter_Close_24",cielo_close_sbend, Metal_width = 200 , diss_to_metal = 17   ,Width_WG=4)
insert_tiles([25],"Spliter_Close_25",cielo_close_sbend, Metal_width = 200 , diss_to_metal = 17  ,Width_WG=4.5)
insert_tiles([26],"Spliter_Close_26",cielo_close_sbend, Metal_width = 200 , diss_to_metal = 17  ,Width_WG=5)
insert_tiles([27],"Spliter_Close_27",cielo_close_sbend, Metal_width = 200 , diss_to_metal = 17  ,Width_WG=5.5)
...
insert_tiles([30],"phase Spliter_Open_30",cielo_sbend, Metal_width = 20 , diss_to_metal = 17 ,Width_WG=5)
insert_tiles([31],"phase Spliter_Open_31",cielo_sbend, Metal_width = 20 , diss_to_metal = 17 ,Width_WG=5.5)
insert_tiles([32],"phase Spliter_Open_32",cielo_sbend_old, Metal_width = 200 , diss_to_metal = 17 ,Width_WG=4)
insert_tiles([33],"phase Spliter_Open_33",cielo_sbend_old, Metal_width = 200 , diss_to_metal = 17 ,Width_WG=4.5)
insert_tiles([34],"phase Spliter_Open_34",cielo_sbend_old, Metal_width = 200 , diss_to_metal = 17 ,Width_WG=5)
...
insert_tiles([43],"1x4_wg=43",cielo_1x4,Width_WG=5.5, C = 0)
...
# ysplitters
insert_tiles([44+2],"Spliter_Close_2",cielo_close_sbend_old , Metal_width = 400 , diss_to_metal = 17 ,Width_WG=5.5)
insert_tiles([44+4],"Spliter_Close_4",cielo_close_sbend_old , Metal_width = 400 , diss_to_metal = 17  ,Width_WG=5)
insert_tiles([44+6],"Spliter_Close_6",cielo_close_sbend_old , Metal_width = 200 , diss_to_metal = 17  ,Width_WG=5.5)
insert_tiles([44+8],"Spliter_Close_8",cielo_close_sbend_old , Metal_width = 200 , diss_to_metal = 17  ,Width_WG=5)
insert_tiles([44+10],"Spliter_Close_10",cielo_close_sbend, Metal_width = 20 , diss_to_metal = 17  ,Width_WG=5.5)
insert_tiles([44+12],"Spliter_Close_12",cielo_close_sbend, Metal_width = 20 , diss_to_metal = 17  ,Width_WG=5)



exportname="test_CIELO_03"
