...
# first
[x1 , y1 , x0 , y0] = cielo(S_height =  400 , M_width = 3000)

#seond Top
[x11 , y11 , x10 ,y10 ] = cielo ( x = x1 , y = y1 , S_height =  90 , M_width = 500)

#second Bottom
[x01 , y01 , x00 ,y00 ] = cielo ( x = x0 , y = y0 , S_height =  90 , M_width = 500)


#third highest
[x111 , y111 , x110 ,y110 ] = cielo ( x = x11 , y = y11 )

#third Mid Top
[x101 , y101 , x100 ,y100 ] = cielo ( x = x10 , y = y10 )

#third Mid Bottom
[x011 , y011 , x010 ,y010 ] = cielo ( x = x01 , y = y01 )

#third Lowest
[x001 , y001 , x000 ,y000 ] = cielo ( x = x00 , y = y00 )




lib.write_gds('cielo spliter1X8.gds')
