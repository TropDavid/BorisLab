...
def cielo (B_length = 1750 , Brad_length = 427 , Brad = 6 , A_length = 5387 , S_length = 6833 , S_height = 210 , S_height_top = 190 , Width_WG = Width_WG , x = 0 , y = 0):
    ...
    rect = gdspy.Rectangle((x-500 , y + S_length/5), (x + 500 , y + S_length + A_length + 4*S_length/5), **ld_METAL2)
