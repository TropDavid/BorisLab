...
def cielo (B_length = 1750 , Brad_length = 426 , Brad = 6 , A_length = 12220 , S_length = 6833 , S_height = 210 , S_heigth_top = 190 
           , Width_WG = Width_WG ,M_width = Metal_width  , x = 0 , y = 0  , sign_at_top = 0 , holes_width = holes_width , diss_holes_wg = diss_holes_wg):
   ...
   rect = gdspy.Rectangle((x - M_width , y + S_length/2), (x + M_width , y + S_length + A_length), **ld_METAL2)
...
# first
[x1 , y1 , x0 , y0] = cielo(S_height = 320 , S_heigth_top = 280 , M_width = 1200)

#seond Top
[x11 , y11 , x10 ,y10 ] = cielo ( x = x1 , y = y1 , S_height = 110 , S_heigth_top = 90 , M_width = 320 , holes_width = 140 , diss_holes_wg = 24)

#second Bottom
[x01 , y01 , x00 ,y00 ] = cielo ( x = x0 , y = y0, S_height = 110 , S_heigth_top = 90 , M_width = 320  , holes_width = 140  , diss_holes_wg = 24)
