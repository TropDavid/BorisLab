...
def MMI (B_length = 1000 , Brad_length = 200 , Brad = 0.3 , MMI_length = 15 , MMI_width = 5 , diss_edge = 0.5 
         ,A_length = 1000 , S_length = 1000 , S_height = 150 , Width_WG = Width_WG , x = 0 , y = 0 , Metal = 0):
